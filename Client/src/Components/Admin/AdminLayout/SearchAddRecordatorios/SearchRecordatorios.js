  ...
  const formik = useFormik({
    ...
    onSubmit: async (formData) => {
      try {
        ...
        const response = await recordatorioApi.createRecordatorio(accesToken, formData)
      ...
      <div className="search-recordatorios">
        <img className='img-alert-recordatorio' src={iconAlert} alt="alert"/>
          <Form className='form-recordatorios' onSubmit={formik.handleSubmit}>
            <Input className='input-recordatorio-name' value={formik.values.nombre}  name="nombre" type="text" onChange={formik.handleChange} placeholder="Nombre"/>
            <Input className='input-recordatorio' value={formik.values.descripcion} name="descripcion" type="text" onChange={formik.handleChange} placeholder="Agregar Recordatorio"/>
            <Checkbox
            ...
            />
            <Button className='btn-recordatorio' type='submit' size='small' loading={formik.isSubmitting} onSubmit={formik.handleSubmit} >
